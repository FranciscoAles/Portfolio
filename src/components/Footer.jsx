...
import { SiDiscord, SiUpwork, SiYoutube } from '@icons-pack/react-simple-icons';
import { BriefcaseBusiness, PlaySquare } from 'lucide-react';
...
export default function Footer() {
    ...
    const handleCopyDiscord = (e) => {
        e.preventDefault();
        navigator.clipboard.writeText('sanfrancisco1373');
        ...
        <footer className="bg-[#0a0a0f] pt-16 pb-8 px-6 md:px-16 rounded-t-[3rem] border-t border-brand-brown/50 relative z-50 mt-8 shadow-[0_-20px_50px_rgba(0,0,0,0.5)]">
            <div className={`max-w-7xl mx-auto ${hasAnyImage ? 'grid grid-cols-1 md:grid-cols-12 gap-8 md:gap-8 mb-8' : 'text-center mb-8'}`}>
                ...
                <div className={hasAnyImage ? 'col-span-1 md:col-span-5 flex flex-col justify-between' : ''}>
                    ...
                    {/* Social Links */}
                    <div className={`mt-8 flex flex-wrap items-center gap-4 ${hasAnyImage ? '' : 'justify-center'}`}>
                        <a
                            href="https://www.linkedin.com/in/francisco-alesandroni-b173a9296"
                            target="_blank"
                            rel="noopener noreferrer"
                            className="w-10 h-10 bg-brand-dark border border-brand-brown/30 rounded-full flex shrink-0 items-center justify-center hover:bg-brand-ocean hover:border-brand-ocean transition-all duration-300 group"
                            title="LinkedIn"
                        >
                        ...
                        <a
                            ...
                            className="w-10 h-10 bg-brand-dark border border-brand-brown/30 rounded-full flex shrink-0 items-center justify-center hover:bg-brand-amber hover:border-brand-amber transition-all duration-300 group"
                            title="Email"
                        >
                        ...
                        <a
                            href="https://contra.com/francisco_alesandroni_ybf7g49l/work"
                            target="_blank"
                            rel="noopener noreferrer"
                            className="w-10 h-10 bg-brand-dark border border-brand-brown/30 rounded-full flex shrink-0 items-center justify-center hover:bg-brand-ocean hover:border-brand-ocean transition-all duration-300 group"
                            title="Contra"
                        >
                            <BriefcaseBusiness className="w-5 h-5 text-brand-light group-hover:text-brand-dark transition-colors" />
                        </a>
                        <a
                            href="https://ytjobs.co/talent/profile/519884"
                            target="_blank"
                            rel="noopener noreferrer"
                            className="w-10 h-10 bg-brand-dark border border-brand-brown/30 rounded-full flex shrink-0 items-center justify-center hover:bg-brand-amber hover:border-brand-amber transition-all duration-300 group"
                            title="YTJobs"
                        >
                            <PlaySquare className="w-5 h-5 text-brand-light group-hover:text-brand-dark transition-colors" />
                        </a>
                        <a
                            href="#"
                        ...
                        >
                            <SiDiscord color="currentColor" className="w-5 h-5 text-brand-light group-hover:text-brand-dark transition-colors" />
                        </a>
                        <a
                            href="https://www.upwork.com/freelancers/~019824b408362d352f"
                            target="_blank"
                            rel="noopener noreferrer"
                            className="w-10 h-10 bg-brand-dark border border-brand-brown/30 rounded-full flex shrink-0 items-center justify-center hover:bg-brand-amber hover:border-brand-amber transition-all duration-300 group"
                            title="Upwork"
                        >
                            <SiUpwork color="currentColor" className="w-5 h-5 text-brand-light group-hover:text-brand-dark transition-colors" />
                        </a>
                        <a
                            href="https://www.youtube.com/channel/UCFmOjwgmyDxROvq3AIFVM6Q"
                            target="_blank"
                            rel="noopener noreferrer"
                            className="w-10 h-10 bg-brand-dark border border-brand-brown/30 rounded-full flex shrink-0 items-center justify-center hover:bg-brand-ocean hover:border-brand-ocean transition-all duration-300 group"
                            title="YouTube"
                        >
                            <SiYoutube color="currentColor" className="w-5 h-5 text-brand-light group-hover:text-brand-dark transition-colors" />
                        </a>
                    </div>
                </div>
